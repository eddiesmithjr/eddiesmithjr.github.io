...
/*  
*   The Identity function returns whatever value that
*   is being passed into the function itself.
*/
...
/*
*   The typeOf function returns the type of value 
*   that has been passed into the function.
*/
_.typeOf = function(type) {
    return Object.prototype.toString.call(type).toLowerCase().slice(8, -1);
};
...
_.first = function(arr, num) {
    if (!Array.isArray(arr) || num < 0) {
        return [];
    } else if (num === undefined || num === isNaN) {
        return arr[0];
...
_.each = function(collection, funky) {
    if (Array.isArray(collection)) {
        for (var i = 0; i < collection.length; i++) {
            funky(collection[i], i, collection);
        } 
        
    } else if (typeof collection === 'object') {
        for (var key in collection) {
            funky(collection[key], key, collection);
        }
    }
...
_.partition = function(arr, func) {
    var newArray = [];   
    newArray.push(_.filter(arr, func));
    newArray.push(_.reject(arr, func));
    return newArray;
...
_.every = function(coll, func) {
    ...
    _.each(coll, function(e, i, a) {
        ...
        if (!func(e, i, a)) {return result = false;}
...
_.some = function(coll, func) {
    ...
    _.each(coll, function(e, i, a) {
        ...
        if (func(e, i, a)) {return result = true;}
...
_.reduce = function(arr, func, seed) {
    var reset = arguments.length < 3;
    
    _.each(arr, function(e, i, arr) {
        if (reset) {
            reset = false;
            seed = e;
        } else seed = func(seed, e, i, arr);
